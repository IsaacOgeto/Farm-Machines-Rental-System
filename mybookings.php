...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT * FROM RENTED_MACHINES RM, MACHINES M
    WHERE RM.customer_username='$login_customer' AND M.MACHINE_ID=RM.MACHINE_ID AND RM.RETURN_STATUS='R'";
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">You have not rented any machine till now!</h1>
        <p class="text-center"> Please rent a machine in order to view your history here. </p>
      </div>
    </div>
